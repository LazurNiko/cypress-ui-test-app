...
describe('Everyone', () => {
  ...
  it('"Everyone" page has logo, [New] "button, pages links, bell icon, users list and filter fields', () => {
    ...
    Everyone.mainPageFriendsLink().should('have.attr', 'href', '/contacts').and("contain", "Friends");
  ...
  it.only('User not be able to create payment request if account balance is "$0.00', () => {
    ...
    Everyone.alertTransactionMessage().should('have.text', 'Paid "$0.00" for any. Not enough money');
  })
})
